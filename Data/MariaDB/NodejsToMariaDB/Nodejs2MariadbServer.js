    ...
    switch (request_url_path) {
            ...
            if ((typeof (request_POST_JSON) === 'object' && Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object object]' && !(request_POST_JSON.length)) && (JSON.stringify(request_POST_JSON) !== '{}')) {
                ...
                if (dbTableName !== "") {
                    ...
                    for (let key_POST in request_POST_JSON) {
                        ...
                        if ((key_POST !== "table_name") && (key_POST !== "collection_name") && (String(key_POST).length > 0) && (String(request_POST_JSON[key_POST]).length > 0)) {
                            SQL_String = SQL_String + "\`";
                    ...
                    if (request_POST_JSON.hasOwnProperty("table_name")) {
                        if (String(request_POST_JSON["table_name"]).length > 0) {
                            // console.log(request_POST_JSON["table_name"]);

                            // 拼接 SQL 語句字符串待新建的數據表（TABLE）名字符串;
                            SQL_String = SQL_String + "\`";
                            SQL_String = SQL_String + String(request_POST_JSON["table_name"]);
                            SQL_String = SQL_String + "\`";
                            SQL_String = SQL_String + " (";
                    ...
                    } else if (request_POST_JSON.hasOwnProperty("collection_name")) {
                        if (String(request_POST_JSON["collection_name"]).length > 0) {
                            // console.log(request_POST_JSON["collection_name"]);

                            // 拼接 SQL 語句字符串待新建的數據表（TABLE）名字符串;
                            SQL_String = SQL_String + "\`";
                            SQL_String = SQL_String + String(request_POST_JSON["collection_name"]);
                            SQL_String = SQL_String + "\`";
                            SQL_String = SQL_String + " (";
                            ...
                            for (let key_POST in request_POST_JSON) {
                                // console.log(key_POST);
                                // console.log(request_POST_JSON[key_POST]);
                                if ((key_POST !== "collection_name") && (key_POST !== "table_name") && (String(key_POST).length > 0) && (String(request_POST_JSON[key_POST]).length > 0)) {
                                    SQL_String = SQL_String + "\`";
                                    SQL_String = SQL_String + String(key_POST);
                                    SQL_String = SQL_String + "\`";
                                    SQL_String = SQL_String + " ";
                    ...
                    if (dbTableName !== "") {
                        ...
                        if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]') && (request_POST_JSON.length > 0)) {
                            ...
                            for (let i = 0; i < request_POST_JSON.length; i++) {
                                ...
                                SQL_String = String("INSERT INTO " + "\`" + String(dbTableName) + "\`" + " (");

                                if ((typeof (request_POST_JSON[i]) === 'object' && Object.prototype.toString.call(request_POST_JSON[i]).toLowerCase() === '[object object]' && !(request_POST_JSON[i].length)) && (JSON.stringify(request_POST_JSON[i]) !== '{}')) {
                                    ...
                                    for (let key_POST in request_POST_JSON[i]) {
                                        ...
                                        if ((key_POST !== "table_name") && (key_POST !== "collection_name") && (String(key_POST).length > 0)) {
                                            SQL_String = SQL_String + "\`";
                                            SQL_String = SQL_String + String(key_POST);
                                            SQL_String = SQL_String + "\`";
                                            SQL_String = SQL_String + ",";
                        ...
                        } else if ((typeof (request_POST_JSON) === 'object' && Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object object]' && !(request_POST_JSON.length)) && (JSON.stringify(request_POST_JSON) !== '{}')) {
                        ...
                        console.log("error, Table(Collection) name is empty.");
                        response_data_JSON["Database_say"] = "error, Table(Collection) name is empty.";
                        response_body_String = JSON.stringify(response_data_JSON);  // 將JOSN對象轉換為JSON字符串;
                        // String = JSON.stringify(JSON); JSON = JSON.parse(String);
                        if (callback) { callback(response_body_String, null); };
                ...
                if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]' && request_POST_JSON.length > 0 && (typeof (request_POST_JSON[0]) === 'object' && Object.prototype.toString.call(request_POST_JSON[0]).toLowerCase() === '[object object]' && !(request_POST_JSON[0].length) && JSON.stringify(request_POST_JSON[0]) !== '{}')) || (typeof (request_POST_JSON) === 'object' && Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object object]' && !(request_POST_JSON.length) && JSON.stringify(request_POST_JSON) !== '{}')) {
                    ...
                    if (dbTableName !== "") {
                        ...
                        if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]') && (request_POST_JSON.length > 0)) {
                            ...
                            if ((typeof (request_POST_JSON[0]) === 'object' && Object.prototype.toString.call(request_POST_JSON[0]).toLowerCase() === '[object object]' && !(request_POST_JSON[0].length)) && (JSON.stringify(request_POST_JSON[0]) !== '{}')) {
                                ...
                                if (String(SQL_String).length > 0) {
                                    if (String(SQL_String.slice(-3)) === "),(") {
                                        SQL_String = String(SQL_String.slice(0, -3));
                                    };
                                };
                    ...
                    if (dbTableName !== "") {
                        ...
                        if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]') && (request_POST_JSON.length > 0)) {
                            ...
                            for (let i = 0; i < request_POST_JSON.length; i++) {
                                ...
                                // 拼接 SQL 語句字符串待操作數據表（TABLE）名字符串;
                                SQL_String = String("DELETE FROM " + "\`" + String(dbTableName) + "\`");
                                ...
                                if (typeof (request_POST_JSON[i]) === 'object' && Object.prototype.toString.call(request_POST_JSON[i]).toLowerCase() === '[object object]' && !(request_POST_JSON[i].length)) {
                                    ...
                                    if (JSON.stringify(request_POST_JSON[i]) !== '{}') {
                            ...
                            if (JSON.stringify(request_POST_JSON) !== '{}') {
                ...
                if (Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]' && request_POST_JSON.length > 0) {
                    ...
                    if (dbTableName !== "") {
                        ...
                        if (typeof (request_POST_JSON[0]) === 'object' && Object.prototype.toString.call(request_POST_JSON[0]).toLowerCase() === '[object object]' && !(request_POST_JSON[0].length)) {
                            ...
                            if (JSON.stringify(request_POST_JSON[0]) !== '{}') {
                                ...
                                if (request_POST_JSON.length === 1) {
                                    ...
                                    if ((typeof (request_POST_JSON[1]) === 'undefined') || ((typeof (request_POST_JSON[1]) === 'object') && (request_POST_JSON[1] === null)) || ((Object.prototype.toString.call(request_POST_JSON[1]).toLowerCase() === '[object string]') && (request_POST_JSON[1] === ""))) {
                                        ...
                                        if (JSON.stringify(request_POST_JSON[1]) === '{}') {
                ...
                if (Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]' && request_POST_JSON.length > 0) {
                    ...
                    if (dbTableName !== "") {
                        ...
                        for (let i = 0; i < request_POST_JSON.length; i++) {
                            ...
                            // 拼接 SQL 語句字符串待新建的數據表（TABLE）名字符串;
                            SQL_String = String("UPDATE " + "\`" + String(dbTableName) + "\`");

                            if (Object.prototype.toString.call(request_POST_JSON[i]).toLowerCase() === '[object array]' && request_POST_JSON[i].length > 0) {
                                ...
                                if (typeof (request_POST_JSON[i][0]) === 'object' && Object.prototype.toString.call(request_POST_JSON[i][0]).toLowerCase() === '[object object]' && !(request_POST_JSON[i][0].length)) {
                                    ...
                                    if (JSON.stringify(request_POST_JSON[i][0]) !== '{}') {
                                        ...
                                        if (request_POST_JSON[i].length === 1) {
                                            ...
                                            if ((typeof (request_POST_JSON[i][1]) === 'undefined') || ((typeof (request_POST_JSON[i][1]) === 'object') && (request_POST_JSON[i][1] === null)) || ((Object.prototype.toString.call(request_POST_JSON[i][1]).toLowerCase() === '[object string]') && (request_POST_JSON[i][1] === ""))) {
                                                ...
                                                if (JSON.stringify(request_POST_JSON[i][1]) === '{}') {
        ...
        // https://mariadb.com/docs/server/mariadb-quickstart-guides/mariadb-sql-cheat-cheat-guide
            ...
            if (MariaDB_Client !== null) {
                ...
                if (Object.prototype.toString.call(selectFieldName).toLowerCase() === '[object array]') {
                            ...
                            if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]') && (request_POST_JSON.length > 0)) {
                                ...
                                for (let i = 0; i < request_POST_JSON.length; i++) {
                                    ...
                                    if (typeof (request_POST_JSON[i]) === 'object' && Object.prototype.toString.call(request_POST_JSON[i]).toLowerCase() === '[object object]' && !(request_POST_JSON[i].length)) {
                                        ...
                                        if (!((JSON.stringify(request_POST_JSON[i]) === '{}') || ((Object.keys(request_POST_JSON[i]).length === 1) && (request_POST_JSON[i].hasOwnProperty("selectFieldName"))))) {
                                ...
                                if (!((JSON.stringify(request_POST_JSON) === '{}') || ((Object.keys(request_POST_JSON).length === 1) && (request_POST_JSON.hasOwnProperty("selectFieldName"))))) {
                                        ...
                                        MariaDB_Client.query(
                                            ...
                                            function(
                                                ...
                                                if (results) {
                                                    ...
                                                    // response_body_String = JSON.stringify(results);
                                                    response_data_JSON["Database_say"] = JSON.stringify(results);
                                                    response_body_String = JSON.stringify(response_data_JSON);  // 將JOSN對象轉換為JSON字符串;
                                                    // String = JSON.stringify(JSON); JSON = JSON.parse(String);
                                                    if (callback) { callback(null, response_body_String); };
                    ...
                    console.log("error, Request url search [selectFieldName] data unrecognizable.");
                    response_data_JSON["Database_say"] = "error, Request url search [selectFieldName] data unrecognizable.";
                    response_body_String = JSON.stringify(response_data_JSON);  // 將JOSN對象轉換為JSON字符串;
                    // String = JSON.stringify(JSON); JSON = JSON.parse(String);
                    if (callback) { callback(response_body_String, null); };
                    ...
                    if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]' && request_POST_JSON.length > 0 && (typeof (request_POST_JSON[0]) === 'object' && Object.prototype.toString.call(request_POST_JSON[0]).toLowerCase() === '[object object]' && !(request_POST_JSON[0].length) && JSON.stringify(request_POST_JSON[0]) !== '{}')) || (typeof (request_POST_JSON) === 'object' && Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object object]' && !(request_POST_JSON.length) && JSON.stringify(request_POST_JSON) !== '{}')) {
                        ...
                        if ((Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object array]') && (request_POST_JSON.length > 0)) {
                            ...
                            for (let i = 0; i < request_POST_JSON.length; i++) {
                                ...
                                // 拼接 SQL 語句字符串待操作數據表（TABLE）名字符串;
                                SQL_String = String("SELECT COUNT(*) AS RecordCount FROM " + "\`"+ String(dbTableName) + "\`");
